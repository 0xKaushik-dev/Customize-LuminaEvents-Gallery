    ...
    <div className="relative font-sans text-gray-900 bg-white/30 min-h-screen selection:bg-gray-200">
      ...
      <div className="relative z-10">
            ...
            <header className="pt-32 pb-16 px-6 md:pt-48 md:pb-24 max-w-7xl mx-auto" id="home">
              ...
              <div className="mt-16 w-full h-[50vh] md:h-[80vh] bg-gray-100 rounded-3xl overflow-hidden relative group">
                ...
                <div className="absolute bottom-6 right-6 md:bottom-10 md:right-10">
                  <button className="bg-white/90 backdrop-blur text-black px-6 py-3 rounded-full text-sm font-medium hover:bg-white transition-colors flex items-center gap-2">
        ...
        <a
          ...
          className="fixed bottom-24 right-6 md:bottom-6 md:right-6 z-50 bg-[#25D366] text-white p-3 md:p-4 rounded-full shadow-2xl hover:bg-[#128C7E] transition-all duration-300 flex items-center justify-center hover:scale-110 active:scale-90"
        ...
        <div className="fixed bottom-6 right-6 md:hidden z-40">
          <button className="bg-black text-white px-6 py-3 rounded-full shadow-2xl font-medium text-sm flex items-center gap-2">
